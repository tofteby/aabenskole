...
Drupal.linkit.editorDialog.field = {
  ...
  insertLink : function(data) {
    var linkitCache = Drupal.linkit.getLinkitCache(),
      field = $('input[id^="' + linkitCache.editorField + '"]'),
    ...
    if (typeof field_settings.title_field != 'undefined' && typeof linkitCache.link_tmp_title != 'undefined') {
       if ($('[id^="' + field_settings.title_field + '"]').get(0) != 'undefined') {
                    Drupal.behaviors.linkit_field.replaceFieldValue($('[id^="' + field_settings.title_field + '"]').get(0), linkitCache.link_tmp_title);
      }
    }
  }
};
